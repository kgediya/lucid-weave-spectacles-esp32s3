...
//sampler sampler Tweak_N11SmpSC 0:22
...
//texture texture2D Tweak_N11 0:3:0:22
...
//texture texture2DArray Tweak_N11ArrSC 0:34:0:22
//texture texture2DArray Tweak_N2ArrSC 0:35:0:23
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N11 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N2 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N11 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N2 84 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 85 -1
//spec_const int Tweak_N11Layout 86 0
//spec_const int Tweak_N2Layout 87 0
...
#define sc_OutputBounds 1
#endif
#ifndef Tweak_N11HasSwappedViews
#define Tweak_N11HasSwappedViews 0
#elif Tweak_N11HasSwappedViews==1
#undef Tweak_N11HasSwappedViews
#define Tweak_N11HasSwappedViews 1
#endif
...
#ifndef Tweak_N11Layout
#define Tweak_N11Layout 0
#endif
#ifndef SC_USE_UV_TRANSFORM_Tweak_N11
#define SC_USE_UV_TRANSFORM_Tweak_N11 0
#elif SC_USE_UV_TRANSFORM_Tweak_N11==1
#undef SC_USE_UV_TRANSFORM_Tweak_N11
#define SC_USE_UV_TRANSFORM_Tweak_N11 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_Tweak_N11
#define SC_SOFTWARE_WRAP_MODE_U_Tweak_N11 -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_Tweak_N11
#define SC_SOFTWARE_WRAP_MODE_V_Tweak_N11 -1
#endif
#ifndef SC_USE_UV_MIN_MAX_Tweak_N11
#define SC_USE_UV_MIN_MAX_Tweak_N11 0
#elif SC_USE_UV_MIN_MAX_Tweak_N11==1
#undef SC_USE_UV_MIN_MAX_Tweak_N11
#define SC_USE_UV_MIN_MAX_Tweak_N11 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_Tweak_N11
#define SC_USE_CLAMP_TO_BORDER_Tweak_N11 0
#elif SC_USE_CLAMP_TO_BORDER_Tweak_N11==1
#undef SC_USE_CLAMP_TO_BORDER_Tweak_N11
#define SC_USE_CLAMP_TO_BORDER_Tweak_N11 1
#endif
layout(binding=1,std430) readonly buffer sc_RayTracingCasterVertexBuffer
{
float sc_RayTracingCasterVertices[1];
...
uniform int Tweak_N35;
uniform vec4 Port_Value_N003;
uniform vec4 Port_Value_N006;
uniform vec4 Port_Value_N007;
uniform vec4 Port_Value_N008;
uniform vec4 Port_Value_N009;
uniform mat3 Tweak_N2Transform;
uniform vec4 Tweak_N2UvMinMax;
uniform vec4 Tweak_N2BorderColor;
uniform vec4 Port_Default_N005;
uniform float Port_Input1_N037;
uniform vec4 sc_Time;
uniform sc_Camera_t sc_Camera;
uniform vec3 Port_Normal_N021;
uniform mat3 Tweak_N11Transform;
uniform vec4 Tweak_N11UvMinMax;
uniform vec4 Tweak_N11BorderColor;
uniform vec4 Port_Input0_N022;
uniform vec3 Port_Normal_N013;
uniform vec4 Port_Input0_N012;
uniform vec4 Port_Input0_N033;
...
uniform sampler2D Tweak_N11;
uniform sampler2DArray Tweak_N11ArrSC;
...
int Tweak_N11GetStereoViewIndex()
{
int l9_0;
#if (Tweak_N11HasSwappedViews)
{
...
void Node5_Switch(float Switch,vec4 Value0,vec4 Value1,vec4 Value2,vec4 Value3,vec4 Value4,vec4 Default,out vec4 Result,ssGlobals Globals)
{
Switch=Globals.Loop_Index_ID0-float(Tweak_N35);
Switch=floor(Switch);
if (Switch==0.0)
{
Value0=Port_Value_N003;
Result=Value0;
}
else
{
...
void LoopFunction_N38(float Index,float Ratio,inout float Output,ssGlobals Globals)
{
...
#if (Tweak_N2Layout==2)
{
bool l9_2=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N2)!=0));
float l9_3=l9_0.x;
sc_SoftwareWrapEarly(l9_3,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).x);
float l9_4=l9_3;
float l9_5=l9_0.y;
sc_SoftwareWrapEarly(l9_5,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).y);
float l9_6=l9_5;
vec2 l9_7;
float l9_8;
...
{
l9_9=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).x==3;
}
#else
{
l9_9=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0);
}
#endif
float l9_10=l9_4;
float l9_11=1.0;
sc_ClampUV(l9_10,Tweak_N2UvMinMax.x,Tweak_N2UvMinMax.z,l9_9,l9_11);
float l9_12=l9_10;
float l9_13=l9_11;
bool l9_14;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N2)
{
l9_14=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).y==3;
}
#else
{
l9_14=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0);
}
#endif
float l9_15=l9_6;
float l9_16=l9_13;
sc_ClampUV(l9_15,Tweak_N2UvMinMax.y,Tweak_N2UvMinMax.w,l9_14,l9_16);
l9_8=l9_16;
...
#endif
vec2 l9_17=sc_TransformUV(l9_7,(int(SC_USE_UV_TRANSFORM_Tweak_N2)!=0),Tweak_N2Transform);
float l9_18=l9_17.x;
float l9_19=l9_8;
sc_SoftwareWrapLate(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).x,l9_2,l9_19);
float l9_20=l9_17.y;
float l9_21=l9_19;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).y,l9_2,l9_21);
float l9_22=l9_21;
vec3 l9_23=sc_SamplingCoordsViewToGlobal(vec2(l9_18,l9_20),Tweak_N2Layout,Tweak_N2GetStereoViewIndex());
vec4 l9_24=texture(Tweak_N2ArrSC,l9_23,0.0);
vec4 l9_25;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N2)
{
l9_25=mix(Tweak_N2BorderColor,l9_24,vec4(l9_22));
}
#else
{
l9_25=l9_24;
...
#else
{
bool l9_26=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N2)!=0));
float l9_27=l9_0.x;
sc_SoftwareWrapEarly(l9_27,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).x);
float l9_28=l9_27;
float l9_29=l9_0.y;
sc_SoftwareWrapEarly(l9_29,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).y);
float l9_30=l9_29;
vec2 l9_31;
float l9_32;
#if (SC_USE_UV_MIN_MAX_Tweak_N2)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N2)
{
l9_33=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).x==3;
}
#else
{
l9_33=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0);
}
#endif
float l9_34=l9_28;
float l9_35=1.0;
sc_ClampUV(l9_34,Tweak_N2UvMinMax.x,Tweak_N2UvMinMax.z,l9_33,l9_35);
float l9_36=l9_34;
float l9_37=l9_35;
bool l9_38;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N2)
{
l9_38=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).y==3;
}
#else
{
l9_38=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0);
}
#endif
float l9_39=l9_30;
float l9_40=l9_37;
sc_ClampUV(l9_39,Tweak_N2UvMinMax.y,Tweak_N2UvMinMax.w,l9_38,l9_40);
l9_32=l9_40;
...
#endif
vec2 l9_41=sc_TransformUV(l9_31,(int(SC_USE_UV_TRANSFORM_Tweak_N2)!=0),Tweak_N2Transform);
float l9_42=l9_41.x;
float l9_43=l9_32;
sc_SoftwareWrapLate(l9_42,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).x,l9_26,l9_43);
float l9_44=l9_41.y;
float l9_45=l9_43;
sc_SoftwareWrapLate(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).y,l9_26,l9_45);
float l9_46=l9_45;
vec3 l9_47=sc_SamplingCoordsViewToGlobal(vec2(l9_42,l9_44),Tweak_N2Layout,Tweak_N2GetStereoViewIndex());
vec4 l9_48=texture(Tweak_N2,l9_47.xy,0.0);
vec4 l9_49;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N2)
{
l9_49=mix(Tweak_N2BorderColor,l9_48,vec4(l9_46));
}
#else
{
l9_49=l9_48;
...
#endif
vec4 param_7;
Node5_Switch(2.0,vec4(0.0),vec4(0.0),vec4(0.0),vec4(0.0),vec4(0.0),Port_Default_N005,param_7,Globals);
Output=min(Output,float(distance(l9_1,param_7)>=Port_Input1_N037));
}
...
vec3 l9_14=-l9_3;
vec4 l9_15;
#if (Tweak_N11Layout==2)
{
bool l9_16=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N11)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N11)!=0));
float l9_17=l9_1.x;
sc_SoftwareWrapEarly(l9_17,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N11,SC_SOFTWARE_WRAP_MODE_V_Tweak_N11).x);
float l9_18=l9_17;
float l9_19=l9_1.y;
sc_SoftwareWrapEarly(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N11,SC_SOFTWARE_WRAP_MODE_V_Tweak_N11).y);
float l9_20=l9_19;
vec2 l9_21;
float l9_22;
#if (SC_USE_UV_MIN_MAX_Tweak_N11)
{
bool l9_23;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N11)
{
l9_23=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N11,SC_SOFTWARE_WRAP_MODE_V_Tweak_N11).x==3;
}
#else
{
l9_23=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N11)!=0);
}
#endif
float l9_24=l9_18;
float l9_25=1.0;
sc_ClampUV(l9_24,Tweak_N11UvMinMax.x,Tweak_N11UvMinMax.z,l9_23,l9_25);
float l9_26=l9_24;
float l9_27=l9_25;
bool l9_28;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N11)
{
l9_28=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N11,SC_SOFTWARE_WRAP_MODE_V_Tweak_N11).y==3;
}
#else
{
l9_28=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N11)!=0);
}
#endif
float l9_29=l9_20;
float l9_30=l9_27;
sc_ClampUV(l9_29,Tweak_N11UvMinMax.y,Tweak_N11UvMinMax.w,l9_28,l9_30);
l9_22=l9_30;
...
#endif
vec2 l9_31=sc_TransformUV(l9_21,(int(SC_USE_UV_TRANSFORM_Tweak_N11)!=0),Tweak_N11Transform);
float l9_32=l9_31.x;
float l9_33=l9_22;
sc_SoftwareWrapLate(l9_32,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N11,SC_SOFTWARE_WRAP_MODE_V_Tweak_N11).x,l9_16,l9_33);
float l9_34=l9_31.y;
float l9_35=l9_33;
sc_SoftwareWrapLate(l9_34,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N11,SC_SOFTWARE_WRAP_MODE_V_Tweak_N11).y,l9_16,l9_35);
float l9_36=l9_35;
vec3 l9_37=sc_SamplingCoordsViewToGlobal(vec2(l9_32,l9_34),Tweak_N11Layout,Tweak_N11GetStereoViewIndex());
vec4 l9_38=texture(Tweak_N11ArrSC,l9_37,0.0);
vec4 l9_39;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N11)
{
l9_39=mix(Tweak_N11BorderColor,l9_38,vec4(l9_36));
}
#else
{
l9_39=l9_38;
...
#else
{
bool l9_40=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N11)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N11)!=0));
float l9_41=l9_1.x;
sc_SoftwareWrapEarly(l9_41,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N11,SC_SOFTWARE_WRAP_MODE_V_Tweak_N11).x);
float l9_42=l9_41;
float l9_43=l9_1.y;
sc_SoftwareWrapEarly(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N11,SC_SOFTWARE_WRAP_MODE_V_Tweak_N11).y);
float l9_44=l9_43;
vec2 l9_45;
float l9_46;
#if (SC_USE_UV_MIN_MAX_Tweak_N11)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N11)
{
l9_47=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N11,SC_SOFTWARE_WRAP_MODE_V_Tweak_N11).x==3;
}
#else
{
l9_47=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N11)!=0);
}
#endif
float l9_48=l9_42;
float l9_49=1.0;
sc_ClampUV(l9_48,Tweak_N11UvMinMax.x,Tweak_N11UvMinMax.z,l9_47,l9_49);
float l9_50=l9_48;
float l9_51=l9_49;
bool l9_52;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N11)
{
l9_52=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N11,SC_SOFTWARE_WRAP_MODE_V_Tweak_N11).y==3;
}
#else
{
l9_52=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N11)!=0);
}
#endif
float l9_53=l9_44;
float l9_54=l9_51;
sc_ClampUV(l9_53,Tweak_N11UvMinMax.y,Tweak_N11UvMinMax.w,l9_52,l9_54);
l9_46=l9_54;
...
#endif
vec2 l9_55=sc_TransformUV(l9_45,(int(SC_USE_UV_TRANSFORM_Tweak_N11)!=0),Tweak_N11Transform);
float l9_56=l9_55.x;
float l9_57=l9_46;
sc_SoftwareWrapLate(l9_56,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N11,SC_SOFTWARE_WRAP_MODE_V_Tweak_N11).x,l9_40,l9_57);
float l9_58=l9_55.y;
float l9_59=l9_57;
sc_SoftwareWrapLate(l9_58,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N11,SC_SOFTWARE_WRAP_MODE_V_Tweak_N11).y,l9_40,l9_59);
float l9_60=l9_59;
vec3 l9_61=sc_SamplingCoordsViewToGlobal(vec2(l9_56,l9_58),Tweak_N11Layout,Tweak_N11GetStereoViewIndex());
vec4 l9_62=texture(Tweak_N11,l9_61.xy,0.0);
vec4 l9_63;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N11)
{
l9_63=mix(Tweak_N11BorderColor,l9_62,vec4(l9_60));
}
#else
{
l9_63=l9_62;
...
#endif
float l9_64=10000000.0;
ssGlobals l9_65=ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_6,l9_5,l9_4,l9_3,l9_2,l9_1,0.0,0.0,5.0);
LoopFunction_N38(0.0,0.0,l9_64,l9_65);
LoopFunction_N38(1.0,0.25,l9_64,l9_65);
LoopFunction_N38(2.0,0.5,l9_64,l9_65);
LoopFunction_N38(3.0,0.75,l9_64,l9_65);
LoopFunction_N38(4.0,1.0,l9_64,l9_65);
vec4 l9_69=mix(Port_Input0_N033,(Tweak_N18*mix(Port_Input0_N022,vec4(max(pow(1.0-abs(dot(l9_14,l9_13*Port_Normal_N021)),Tweak_N19),0.0)*Tweak_N20),smoothstep(vec4(Tweak_N30),vec4(Tweak_N31),l9_15)))+(Tweak_N17*mix(Port_Input0_N012,vec4(max(pow(1.0-abs(dot(l9_14,l9_13*Port_Normal_N013)),Tweak_N15),0.0)*Tweak_N16),smoothstep(vec4(Tweak_N28),vec4(Tweak_N29),l9_15))),vec4(l9_64));
vec4 l9_70=vec4(l9_69.x,l9_69.y,l9_69.z,vec4(0.0).w);
l9_70.w=Port_Value2_N014;
#if (sc_BlendMode_AlphaTest)
{
if (Port_Value2_N014<alphaTestThreshold)
{
discard;
}
}
...
{
if (Port_Value2_N014<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_75=clamp(Port_Value2_N014*2.0,0.0,1.0);
}
#else
{
float l9_76;
...
{
l9_76=clamp(dot(l9_70.xyz,vec3(Port_Value2_N014)),0.0,1.0);
}
#else
{
float l9_77;
...
{
l9_78=(1.0-dot(l9_70.xyz,vec3(0.33333001)))*Port_Value2_N014;
}
#else
{
float l9_79;
...
{
l9_79=(1.0-clamp(dot(l9_70.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N014;
}
#else
{
float l9_80;
...
{
l9_80=clamp(dot(l9_70.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N014;
}
#else
{
float l9_81;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_82=clamp(dot(l9_70.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N014;
}
#else
{
float l9_83;
...
{
l9_83=dot(l9_70.xyz,vec3(0.33333001))*Port_Value2_N014;
}
#else
{
float l9_84;
...
#endif
vec3 l9_91=mix(l9_88.xyz,definedBlend(l9_88.xyz,l9_70.xyz).xyz,vec3(Port_Value2_N014));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_96=vec4(mix(vec3(1.0),l9_70.xyz,vec3(Port_Value2_N014)),Port_Value2_N014);
}
#else
{
vec4 l9_97;
...
{
l9_98=clamp(Port_Value2_N014,0.0,1.0);
}
#else
{
l9_98=Port_Value2_N014;
}
#endif
