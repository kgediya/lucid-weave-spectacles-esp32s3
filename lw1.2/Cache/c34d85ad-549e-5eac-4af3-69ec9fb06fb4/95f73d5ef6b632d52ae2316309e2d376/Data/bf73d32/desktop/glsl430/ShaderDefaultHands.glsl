...
uniform float Port_Input2_N036;
uniform float Port_Import_N037;
uniform float Port_Exponent_N007;
uniform float Port_Intensity_N007;
uniform float Port_Opacity_N006;
...
float l9_7=length(l9_1);
float l9_8=mod((sc_Time.x*((Port_Value_N001+0.001)-0.001))+(l9_7*(1.0/((Port_Value_N000+0.001)-0.001))),(Port_Value_N003+0.001)-0.001);
float l9_9=((1.0-l9_8)*l9_8)*Port_Input2_N036;
float l9_10;
if (l9_9<=0.0)
{
l9_10=0.0;
...
{
l9_10=pow(l9_9,Port_Import_N037);
}
vec4 l9_11=vec4(l9_10);
vec3 l9_12=-l9_4;
float l9_13=dot(l9_12,l9_2);
vec3 l9_14;
#if (!sc_ProjectiveShadowsCaster)
{
l9_14=l9_2;
...
#endif
vec3 l9_15=max(Port_Value_N014.xyz,vec3(0.0));
vec4 l9_16;
#if (sc_ProjectiveShadowsCaster)
{
l9_16=vec4(l9_15,Port_Opacity_N006);
}
#else
{
l9_16=ngsCalculateLighting(l9_15,Port_Opacity_N006,l9_14,l9_3,l9_4,max((mix(Port_Value_N008,Port_Value_N016,l9_11)*vec4(max(pow(1.0-abs(l9_13),Port_Exponent_N007),0.0)*Port_Intensity_N007)).xyz,vec3(0.0)),Port_Metallic_N006,Port_Roughness_N006,Port_AO_N006,Port_SpecularAO_N006);
}
#endif
vec4 l9_17=max(l9_16,vec4(0.0));
if (l9_0)
{
vec4 l9_18;
...
{
float l9_42=l9_17.w;
l9_41=vec4(mix(vec3(1.0),l9_17.xyz,vec3(l9_42)),l9_42);
}
#else
{
vec4 l9_43;
...
#endif
l9_43=vec4(l9_17.xyz*l9_45,l9_45);
}
#else
{
l9_43=l9_17;
...
vec4 l9_48=sc_OutputMotionVectorIfNeeded(max(l9_46,vec4(0.0)));
