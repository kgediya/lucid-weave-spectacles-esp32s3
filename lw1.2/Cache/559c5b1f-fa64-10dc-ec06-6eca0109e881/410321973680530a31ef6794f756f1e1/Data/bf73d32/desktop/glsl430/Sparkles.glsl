...
//sampler sampler opacitySmpSC 0:17
...
//texture texture2D opacity 0:1:0:17
...
//texture texture2DArray opacityArrSC 0:26:0:17
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_opacity 32 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 33 0
//spec_const bool SC_USE_UV_MIN_MAX_opacity 34 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 35 0
//spec_const bool SC_USE_UV_TRANSFORM_opacity 36 0
//spec_const bool Tweak_N10 37 0
//spec_const bool UseViewSpaceDepthVariant 38 1
//spec_const bool intensityTextureHasSwappedViews 39 0
//spec_const bool opacityHasSwappedViews 40 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacity 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacity 79 -1
//spec_const int intensityTextureLayout 80 0
//spec_const int opacityLayout 81 0
...
#define sc_OutputBounds 1
#endif
#ifndef opacityHasSwappedViews
#define opacityHasSwappedViews 0
#elif opacityHasSwappedViews==1
#undef opacityHasSwappedViews
#define opacityHasSwappedViews 1
#endif
#ifndef Tweak_N10
#define Tweak_N10 0
#elif Tweak_N10==1
...
#define Tweak_N10 1
#endif
#ifndef opacityLayout
#define opacityLayout 0
#endif
#ifndef SC_USE_UV_TRANSFORM_opacity
#define SC_USE_UV_TRANSFORM_opacity 0
#elif SC_USE_UV_TRANSFORM_opacity==1
#undef SC_USE_UV_TRANSFORM_opacity
#define SC_USE_UV_TRANSFORM_opacity 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_opacity
#define SC_SOFTWARE_WRAP_MODE_U_opacity -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_opacity
#define SC_SOFTWARE_WRAP_MODE_V_opacity -1
#endif
#ifndef SC_USE_UV_MIN_MAX_opacity
#define SC_USE_UV_MIN_MAX_opacity 0
#elif SC_USE_UV_MIN_MAX_opacity==1
#undef SC_USE_UV_MIN_MAX_opacity
#define SC_USE_UV_MIN_MAX_opacity 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_opacity
#define SC_USE_CLAMP_TO_BORDER_opacity 0
#elif SC_USE_CLAMP_TO_BORDER_opacity==1
#undef SC_USE_CLAMP_TO_BORDER_opacity
#define SC_USE_CLAMP_TO_BORDER_opacity 1
#endif
#ifndef sc_DepthOnly
...
uniform vec2 Port_Input1_N018;
uniform float Port_Value4_N024;
uniform float Port_Input1_N032;
uniform mat3 opacityTransform;
uniform vec4 opacityUvMinMax;
uniform vec4 opacityBorderColor;
uniform vec4 sc_Time;
uniform float Port_Default_N031;
uniform int PreviewEnabled;
uniform sampler2D opacity;
uniform sampler2DArray opacityArrSC;
...
in vec4 varColor;
void Node21_Rotate_Coords(vec2 CoordsIn,float Rotation,vec2 Center,out vec2 CoordsOut,ssGlobals Globals)
{
...
void Node22_Rotate_Coords(vec2 CoordsIn,float Rotation,vec2 Center,out vec2 CoordsOut,ssGlobals Globals)
{
float l9_0=sin(radians(Rotation));
float l9_1=cos(radians(Rotation));
CoordsOut=CoordsIn-Center;
...
void Node23_Rotate_Coords(vec2 CoordsIn,float Rotation,vec2 Center,out vec2 CoordsOut,ssGlobals Globals)
{
float l9_0=sin(radians(Rotation));
float l9_1=cos(radians(Rotation));
CoordsOut=CoordsIn-Center;
...
void Node29_If_else(float Bool1,vec4 Value1,vec4 Default,out vec4 Result,ssGlobals Globals)
{
Bool1=float(Tweak_N30);
if ((Bool1*1.0)!=0.0)
{
float l9_0=Globals.gTimeElapsed*speed;
vec2 param_3;
Node21_Rotate_Coords(vec2(l9_0*Port_Input1_N011)+Globals.Surface_UVCoord0,Port_Rotation_N021,Port_Center_N021,param_3,Globals);
float l9_1=Port_Input0_N036-(noiseScale*Port_Input1_N037);
vec2 l9_2=floor(param_3*vec2(l9_1*Port_Input1_N002));
vec2 l9_3=ssRandVec2((int(l9_2.x)*15299)^(int(l9_2.y)*30133));
vec2 param_8;
Node22_Rotate_Coords(Globals.Surface_UVCoord0,Port_Rotation_N022,Port_Center_N022,param_8,Globals);
vec2 l9_4=floor((param_8+Port_Input1_N038)*vec2(l9_1*Port_Input1_N009));
vec2 l9_5=ssRandVec2((int(l9_4.x)*15299)^(int(l9_4.y)*30133));
vec2 param_13;
Node23_Rotate_Coords(Globals.Surface_UVCoord0+vec2(l9_0*Port_Input1_N014),Port_Rotation_N023,Port_Center_N023,param_13,Globals);
vec2 l9_6=floor((param_13+Port_Input1_N018)*vec2(l9_1));
vec2 l9_7=ssRandVec2((int(l9_6.x)*15299)^(int(l9_6.y)*30133));
vec4 l9_8=vec4(l9_3.x,l9_5.x,l9_7.x,Port_Value4_N024);
vec2 l9_9=(l9_3*l9_5)*l9_7;
float l9_10=(1.0-intensity)-Port_Input1_N032;
float l9_11=l9_9.x;
float l9_12;
if (l9_11<=0.0)
{
...
{
l9_14=pow(l9_13,l9_10);
}
vec4 l9_15=vec4(l9_12,l9_14,0.0,0.0);
vec3 l9_16=l9_8.xyz*Port_Value4_N024;
vec4 l9_17=vec4(l9_16.x,l9_16.y,l9_16.z,l9_8.w);
vec4 l9_18=min((l9_17*l9_17)/(vec4(1.0)-l9_15),vec4(1.0));
bvec4 l9_19=equal(l9_15,vec4(1.0));
Value1=vec4(l9_19.x ? l9_15.x : l9_18.x,l9_19.y ? l9_15.y : l9_18.y,l9_19.z ? l9_15.z : l9_18.z,l9_19.w ? l9_15.w : l9_18.w);
Result=Value1;
}
else
{
float l9_20=Globals.gTimeElapsed*speed;
vec2 param_18;
Node21_Rotate_Coords(vec2(l9_20*Port_Input1_N011)+Globals.Surface_UVCoord0,Port_Rotation_N021,Port_Center_N021,param_18,Globals);
float l9_21=Port_Input0_N036-(noiseScale*Port_Input1_N037);
vec2 l9_22=floor(param_18*vec2(l9_21*Port_Input1_N002));
vec2 l9_23=ssRandVec2((int(l9_22.x)*15299)^(int(l9_22.y)*30133));
vec2 param_23;
Node22_Rotate_Coords(Globals.Surface_UVCoord0,Port_Rotation_N022,Port_Center_N022,param_23,Globals);
vec2 l9_24=floor((param_23+Port_Input1_N038)*vec2(l9_21*Port_Input1_N009));
vec2 l9_25=ssRandVec2((int(l9_24.x)*15299)^(int(l9_24.y)*30133));
vec2 param_28;
Node23_Rotate_Coords(Globals.Surface_UVCoord0+vec2(l9_20*Port_Input1_N014),Port_Rotation_N023,Port_Center_N023,param_28,Globals);
vec2 l9_26=floor((param_28+Port_Input1_N018)*vec2(l9_21));
vec2 l9_27=ssRandVec2((int(l9_26.x)*15299)^(int(l9_26.y)*30133));
vec2 l9_28=(l9_23*l9_25)*l9_27;
float l9_29=(1.0-intensity)-Port_Input1_N032;
float l9_30=l9_28.x;
float l9_31;
if (l9_30<=0.0)
{
...
{
l9_33=pow(l9_32,l9_29);
}
Default=vec4(l9_31,l9_33,0.0,0.0);
Result=Default;
}
}
int sc_GetStereoViewIndex()
...
int opacityGetStereoViewIndex()
{
int l9_0;
#if (opacityHasSwappedViews)
{
...
#endif
vec4 param_3;
Node29_If_else(0.0,vec4(0.0),vec4(0.0),param_3,ssGlobals(sc_Time.x,sc_Time.y,0.0,varTex01.xy));
vec4 l9_0=param_3;
float l9_1;
#if (Tweak_N10)
{
...
#if (opacityLayout==2)
{
bool l9_3=(int(SC_USE_CLAMP_TO_BORDER_opacity)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacity)!=0));
float l9_4=varTex01.x;
sc_SoftwareWrapEarly(l9_4,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacity,SC_SOFTWARE_WRAP_MODE_V_opacity).x);
float l9_5=l9_4;
float l9_6=varTex01.y;
sc_SoftwareWrapEarly(l9_6,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacity,SC_SOFTWARE_WRAP_MODE_V_opacity).y);
float l9_7=l9_6;
vec2 l9_8;
float l9_9;
#if (SC_USE_UV_MIN_MAX_opacity)
{
bool l9_10;
#if (SC_USE_CLAMP_TO_BORDER_opacity)
{
l9_10=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacity,SC_SOFTWARE_WRAP_MODE_V_opacity).x==3;
}
#else
{
l9_10=(int(SC_USE_CLAMP_TO_BORDER_opacity)!=0);
}
#endif
float l9_11=l9_5;
float l9_12=1.0;
sc_ClampUV(l9_11,opacityUvMinMax.x,opacityUvMinMax.z,l9_10,l9_12);
float l9_13=l9_11;
float l9_14=l9_12;
bool l9_15;
#if (SC_USE_CLAMP_TO_BORDER_opacity)
{
l9_15=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacity,SC_SOFTWARE_WRAP_MODE_V_opacity).y==3;
}
#else
{
l9_15=(int(SC_USE_CLAMP_TO_BORDER_opacity)!=0);
}
#endif
float l9_16=l9_7;
float l9_17=l9_14;
sc_ClampUV(l9_16,opacityUvMinMax.y,opacityUvMinMax.w,l9_15,l9_17);
l9_9=l9_17;
...
#endif
vec2 l9_18=sc_TransformUV(l9_8,(int(SC_USE_UV_TRANSFORM_opacity)!=0),opacityTransform);
float l9_19=l9_18.x;
float l9_20=l9_9;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacity,SC_SOFTWARE_WRAP_MODE_V_opacity).x,l9_3,l9_20);
float l9_21=l9_18.y;
float l9_22=l9_20;
sc_SoftwareWrapLate(l9_21,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacity,SC_SOFTWARE_WRAP_MODE_V_opacity).y,l9_3,l9_22);
float l9_23=l9_22;
vec3 l9_24=sc_SamplingCoordsViewToGlobal(vec2(l9_19,l9_21),opacityLayout,opacityGetStereoViewIndex());
vec4 l9_25=texture(opacityArrSC,l9_24,0.0);
vec4 l9_26;
#if (SC_USE_CLAMP_TO_BORDER_opacity)
{
l9_26=mix(opacityBorderColor,l9_25,vec4(l9_23));
}
#else
{
l9_26=l9_25;
...
#else
{
bool l9_27=(int(SC_USE_CLAMP_TO_BORDER_opacity)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacity)!=0));
float l9_28=varTex01.x;
sc_SoftwareWrapEarly(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacity,SC_SOFTWARE_WRAP_MODE_V_opacity).x);
float l9_29=l9_28;
float l9_30=varTex01.y;
sc_SoftwareWrapEarly(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacity,SC_SOFTWARE_WRAP_MODE_V_opacity).y);
float l9_31=l9_30;
vec2 l9_32;
float l9_33;
#if (SC_USE_UV_MIN_MAX_opacity)
...
#if (SC_USE_CLAMP_TO_BORDER_opacity)
{
l9_34=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacity,SC_SOFTWARE_WRAP_MODE_V_opacity).x==3;
}
#else
{
l9_34=(int(SC_USE_CLAMP_TO_BORDER_opacity)!=0);
}
#endif
float l9_35=l9_29;
float l9_36=1.0;
sc_ClampUV(l9_35,opacityUvMinMax.x,opacityUvMinMax.z,l9_34,l9_36);
float l9_37=l9_35;
float l9_38=l9_36;
bool l9_39;
#if (SC_USE_CLAMP_TO_BORDER_opacity)
{
l9_39=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacity,SC_SOFTWARE_WRAP_MODE_V_opacity).y==3;
}
#else
{
l9_39=(int(SC_USE_CLAMP_TO_BORDER_opacity)!=0);
}
#endif
float l9_40=l9_31;
float l9_41=l9_38;
sc_ClampUV(l9_40,opacityUvMinMax.y,opacityUvMinMax.w,l9_39,l9_41);
l9_33=l9_41;
...
#endif
vec2 l9_42=sc_TransformUV(l9_32,(int(SC_USE_UV_TRANSFORM_opacity)!=0),opacityTransform);
float l9_43=l9_42.x;
float l9_44=l9_33;
sc_SoftwareWrapLate(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacity,SC_SOFTWARE_WRAP_MODE_V_opacity).x,l9_27,l9_44);
float l9_45=l9_42.y;
float l9_46=l9_44;
sc_SoftwareWrapLate(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacity,SC_SOFTWARE_WRAP_MODE_V_opacity).y,l9_27,l9_46);
float l9_47=l9_46;
vec3 l9_48=sc_SamplingCoordsViewToGlobal(vec2(l9_43,l9_45),opacityLayout,opacityGetStereoViewIndex());
vec4 l9_49=texture(opacity,l9_48.xy,0.0);
vec4 l9_50;
#if (SC_USE_CLAMP_TO_BORDER_opacity)
{
l9_50=mix(opacityBorderColor,l9_49,vec4(l9_47));
}
#else
{
l9_50=l9_49;
...
#else
{
l9_1=Port_Default_N031;
}
#endif
vec4 l9_51=vec4(l9_0.x,l9_0.y,l9_0.z,vec4(0.0).w);
l9_51.w=l9_1;
...
{
l9_55=clamp(dot(l9_51.xyz,vec3(l9_1)),0.0,1.0);
}
#else
{
float l9_56;
...
{
l9_57=(1.0-dot(l9_51.xyz,vec3(0.33333001)))*l9_1;
}
#else
{
float l9_58;
...
{
l9_58=(1.0-clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0))*l9_1;
}
#else
{
float l9_59;
...
{
l9_59=clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0)*l9_1;
}
#else
{
float l9_60;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_61=clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0)*l9_1;
}
#else
{
float l9_62;
...
{
l9_62=dot(l9_51.xyz,vec3(0.33333001))*l9_1;
}
#else
{
float l9_63;
...
{
l9_69=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_68,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_69=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_68,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_67=l9_69;
}
#endif
vec3 l9_70=mix(l9_67.xyz,definedBlend(l9_67.xyz,l9_51.xyz).xyz,vec3(l9_1));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_75=vec4(mix(vec3(1.0),l9_51.xyz,vec3(l9_1)),l9_1);
}
#else
{
vec4 l9_76;
...
vec4 l9_80=sc_OutputMotionVectorIfNeeded(max(l9_78,vec4(0.0)));
