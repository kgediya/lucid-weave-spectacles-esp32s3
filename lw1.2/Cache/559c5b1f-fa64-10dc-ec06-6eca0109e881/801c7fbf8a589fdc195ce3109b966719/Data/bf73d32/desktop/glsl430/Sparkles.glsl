...
vec3 l9_15=l9_8.xyz*Port_Value4_N024;
Value1=min(vec4(l9_15.x,l9_15.y,l9_15.z,l9_8.w)+vec4(l9_12,l9_14,0.0,0.0),vec4(1.0));
Result=Value1;
}
else
{
float l9_16=Globals.gTimeElapsed*speed;
vec2 param_18;
Node21_Rotate_Coords(vec2(l9_16*Port_Input1_N011)+Globals.Surface_UVCoord0,Port_Rotation_N021,Port_Center_N021,param_18,Globals);
float l9_17=Port_Input0_N036-(noiseScale*Port_Input1_N037);
vec2 l9_18=floor(param_18*vec2(l9_17*Port_Input1_N002));
vec2 l9_19=ssRandVec2((int(l9_18.x)*15299)^(int(l9_18.y)*30133));
vec2 param_23;
Node22_Rotate_Coords(Globals.Surface_UVCoord0,Port_Rotation_N022,Port_Center_N022,param_23,Globals);
vec2 l9_20=floor((param_23+Port_Input1_N038)*vec2(l9_17*Port_Input1_N009));
vec2 l9_21=ssRandVec2((int(l9_20.x)*15299)^(int(l9_20.y)*30133));
vec2 param_28;
Node23_Rotate_Coords(Globals.Surface_UVCoord0+vec2(l9_16*Port_Input1_N014),Port_Rotation_N023,Port_Center_N023,param_28,Globals);
vec2 l9_22=floor((param_28+Port_Input1_N018)*vec2(l9_17));
vec2 l9_23=ssRandVec2((int(l9_22.x)*15299)^(int(l9_22.y)*30133));
vec2 l9_24=(l9_19*l9_21)*l9_23;
float l9_25=(1.0-intensity)-Port_Input1_N032;
float l9_26=l9_24.x;
float l9_27;
if (l9_26<=0.0)
{
...
{
l9_29=pow(l9_28,l9_25);
}
Default=vec4(l9_27,l9_29,0.0,0.0);
Result=Default;
}
}
int sc_GetStereoViewIndex()
