...
vec2 l9_8=(l9_3*l9_5)*l9_7;
float l9_9=(1.0-intensity)-Port_Input1_N032;
float l9_10=l9_8.x;
float l9_11;
if (l9_10<=0.0)
{
...
{
l9_13=pow(l9_12,l9_9);
}
Value1=vec4(HSLToRGB(vec3(RGBToHSL((vec4(l9_3.x,l9_5.x,l9_7.x,Port_Value4_N024).xyz*Port_Value4_N024).xyz).xy,RGBToHSL(vec4(l9_11,l9_13,0.0,0.0).xyz).z)),0.0);
Result=Value1;
}
else
{
float l9_14=Globals.gTimeElapsed*speed;
vec2 param_18;
Node21_Rotate_Coords(vec2(l9_14*Port_Input1_N011)+Globals.Surface_UVCoord0,Port_Rotation_N021,Port_Center_N021,param_18,Globals);
float l9_15=Port_Input0_N036-(noiseScale*Port_Input1_N037);
vec2 l9_16=floor(param_18*vec2(l9_15*Port_Input1_N002));
vec2 l9_17=ssRandVec2((int(l9_16.x)*15299)^(int(l9_16.y)*30133));
vec2 param_23;
Node22_Rotate_Coords(Globals.Surface_UVCoord0,Port_Rotation_N022,Port_Center_N022,param_23,Globals);
vec2 l9_18=floor((param_23+Port_Input1_N038)*vec2(l9_15*Port_Input1_N009));
vec2 l9_19=ssRandVec2((int(l9_18.x)*15299)^(int(l9_18.y)*30133));
vec2 param_28;
Node23_Rotate_Coords(Globals.Surface_UVCoord0+vec2(l9_14*Port_Input1_N014),Port_Rotation_N023,Port_Center_N023,param_28,Globals);
vec2 l9_20=floor((param_28+Port_Input1_N018)*vec2(l9_15));
vec2 l9_21=ssRandVec2((int(l9_20.x)*15299)^(int(l9_20.y)*30133));
vec2 l9_22=(l9_17*l9_19)*l9_21;
float l9_23=(1.0-intensity)-Port_Input1_N032;
float l9_24=l9_22.x;
float l9_25;
if (l9_24<=0.0)
{
...
{
l9_27=pow(l9_26,l9_23);
}
Default=vec4(l9_25,l9_27,0.0,0.0);
Result=Default;
}
}
int sc_GetStereoViewIndex()
